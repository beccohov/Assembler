...
CMAIN:
    ...
    call FILL_NUMBER
    add esp, 8 ;rmv
    push dword[second];push arg
    push m ;push arg
    call FILL_NUMBER ; (m,*second)
    add esp, 8 ;rmv
    push k ;push arg
    push m ;push arg
    push result_ ;push arg
    call MULTIPLY_SEQUENCES ;(superlong*,superlong*,superlong*)
    add esp, 12 ;rmv    
    push result_ ;push arg
    call MAKE_SEQUENCE_CLEAR ; (superlong*)
    add esp, 4 ;rmv
    push dword[third] ; push arg
    push l ; push arg
    call FILL_NUMBER ;(superlong*,int)
    add esp,8 ;rmv
    push result_  ;push arg
    push  l ;push arg
    push result__ ;push arg
    call MULTIPLY_SEQUENCES ;(superlong*,superlong*,superlong*)
    add esp, 12 ;rmv
    push result__ ;push arg
    call MAKE_SEQUENCE_CLEAR ; (superlong*)
